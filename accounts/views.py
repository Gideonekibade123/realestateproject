...
from .utils import send_verification_email, send_password_reset_email  # ✅ added send_password_reset_email
...
class ForgotPasswordView(APIView):
    ...
    def post(self, request):
        ...
        try:
            user = User.objects.get(email=email)
            send_password_reset_email(user, request)  # ✅ clean single call
        except User.DoesNotExist:
